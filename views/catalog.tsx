  ...
  if (project && module) {
    ...
    return (
      <>
        ...
        <div className="page-header">
          ...
          <div className="catalog-actions">
            ...
            <button
              ...
              title={module.status === '已归档' ? '模块归档后不能新建功能或模块级任务' : undefined}
        ...
        <div className="calm-tabs module-work-tabs">
          <button type="button" className={ui.moduleTab === '功能目录' ? 'selected' : ''} onClick={() => ui.setModuleTab('功能目录')}>
            功能目录 {moduleFeatures(data, module.id).length}
          </button>
          <button type="button" className={ui.moduleTab === '模块级任务' ? 'selected' : ''} onClick={() => ui.setModuleTab('模块级任务')}>
            模块级任务 {moduleTasks.length}
          </button>
        </div>
