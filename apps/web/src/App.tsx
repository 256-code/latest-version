  ...
  return (
    <Routes>
      <Route element={<Workspace />}>
        ...
        <Route path="tasks" element={<TaskCenterView />} />
        <Route path="catalog" element={<CatalogView />} />
        <Route path="catalog/:projectId" element={<CatalogView />} />
        <Route path="catalog/:projectId/:moduleId" element={<CatalogView />} />
        <Route path="catalog/:projectId/:moduleId/:featureId" element={<CatalogView />} />
